...
float temperatura = 0.01;
float humedad = 0.02;
float temperatura0 = 0.03;
float temperatura1 = 0.04;
float temperatura2 = 0.05;
float temperatura3 = 0.06;
float temperatura4 = 0.07;
float temperatura5 = 0.08;
//<----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/

const int NUMBER_OF_FIELDS_2 = 30; // numero de campos esperados
String save_values_2[NUMBER_OF_FIELDS_2]; // array conteniendo los valores de todos los campos

//<---------------------------------------------------------------------------------------------------------------------------
// Variables para medir el tiempo en que debe enviarse la trama.
unsigned long MILLIS_ACTUAL = 0;
unsigned long MILLIS_PREVIO = 0;
unsigned long INTERVALO = 10000;  // Cada 2 minutos ( 2min x 60s/1min x 1000ms/1s = 120000ms)
...
void leerPT100(){
 ...
 //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  temperatura0 = (temperatura0/ 32) - 256;
  //--------------------------- TEMP 1 ---------------------------------   
  temperatura1 = (double)RTD_CH1.rtd_res_raw;
  temperatura1 = (temperatura1/ 32) - 256;
  //--------------------------------------------------------------------       
 ...
 //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  temperatura3 = (temperatura3/ 32) - 256;
  //--------------------------------------------------------------------  
 ...
 //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  
  ...
  temperatura5 = (temperatura5/ 32) - 256;
  //--------------------------------------------------------------------  
...
/*---------------------------------------------------------------------------------------------------------------------------
* Nombre de la función: envia_trama
* Parámetros          : ninguno
* Valor devuelto      : ninguno
* Descripción         : Envía la información de los sensores por la USART 2 (sólo transmite). Inicia el envío de toda la 
*                       trama que debe llegar al MASTER.
* Se comunica con     : Tablero CAMARA#3 - ver descripción muy muy arriba. 
---------------------------------------------------------------------------------------------------------------------------*/

void envia_trama()
{
      MILLIS_ACTUAL = millis(); // Tomar el tiempo que ha pasado desde que se ha encendido la tarjeta
      
      if(MILLIS_ACTUAL - MILLIS_PREVIO > INTERVALO)
      {
            // Guardar los nuevos valores de tiempo para el próximo ciclo
