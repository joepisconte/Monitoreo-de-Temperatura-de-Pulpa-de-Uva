...
float temperatura = 0.31;
float humedad = 0.32;
float temperatura0 = 0.33;
float temperatura1 = 0.34;
float temperatura2 = 0.35;
float temperatura3 = 0.36;
float temperatura4 = 0.37;
float temperatura5 = 0.38;
//<----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
     ...
     } else if (ch == ',') // si detecta coma, mueve al siguiente campo
     {
          ...
          for(int j = 0; j < NUMBER_OF_FIELDS_2; j++)
          {
               ...
               Serial.print(save_values_2[j]); 
                 ...
                 if(j == 29) { Serial2.print('$');Serial.print('$');}
                 else        { Serial2.print(',');Serial.print(',');}                     
          }
